...
@objc public final class PlaySettings: NSObject {
    ...
    @objc lazy var cursorWidth = settingsData.cursorWidth

    @objc lazy var cursorHeight = settingsData.cursorHeight

    @objc lazy var cursorHotSpotX = settingsData.cursorHotSpotX

    @objc lazy var cursorHotSpotY = settingsData.cursorHotSpotY
}
